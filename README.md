...
When a commit to the `master` branch occurs (for example, when a pull request is merged), Travis CI builds the manuscript and writes the results to the [`gh-pages`](https://github.com/rdvelazquez/hyphy_release_manuscript/tree/gh-pages) and [`output`](https://github.com/rdvelazquez/hyphy_release_manuscript/tree/output) branches.
The `gh-pages` branch uses [GitHub Pages](https://pages.github.com/) to host the following URLs:

+ **HTML manuscript** at https://rdvelazquez.github.io/hyphy_release_manuscript/
+ **PDF manuscript** at https://rdvelazquez.github.io/hyphy_release_manuscript/manuscript.pdf
...
Please attribute by linking to https://github.com/rdvelazquez/hyphy_release_manuscript.
...
Please open [an issue](https://github.com/rdvelazquez/hyphy_release_manuscript/issues) for any question related to licensing.
